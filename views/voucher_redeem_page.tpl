                        ...
                        <div class="col-md-6 ib_right_panel">
                            ...
                            <form class="form-horizontal" id="frm_redeem">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="voucher_number" class="form-control" id="voucher_number" value="{$transaction_data['voucher_number']}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="country_name" class="form-control" id="country_name" value="{$transaction_data['country_name']}" disabled>
                                    </div>

                                    <label class="col-md-2 control-label" for="category">Category</label>
                                    <div class="col-md-4">
                                        <input type="text" name="category" class="form-control" id="category" value="{$transaction_data['category']}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="customer_name" class="form-control" id="customer_name" value="{$transaction_data['customer_name']}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="customer_address" name="customer_address" class="form-control" rows="3" disabled>{$transaction_data['customer_address']}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" value="{$transaction_data['departure_date']}" name="departure_date" id="departure_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true" disabled>
                                    </div>

                                    <label class="col-md-2 control-label" for="category">Return Date</label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" value="{$transaction_data['return_date']}" name="return_date" id="return_date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="remark" name="remark" class="form-control" rows="3" disabled>{$transaction_data['remark']}</textarea>
                                    </div>
                                </div>
                                ...
                                {if $transaction_data['product_name'] neq ''}
                                <div class="hr-line-dashed"></div>

                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-2" style="text-align: left">
                                        <span style="font-size: 12pt; font-weight: 600">{$transaction_data['product_name']}</span>
                                    </div>
                                    <div class="col-md-8" style="text-align: right">
                                        <span class="amount" style="font-weight: 600" autocomplete="off" data-a-sign="{$config['currency_code']} " data-a-dec="{$config['dec_point']}" data-a-sep="{$config['thousands_sep']}" data-d-group="2">{$transaction_data['product_price']}</span>
                                    </div>
                                </div>
                                {/if}

                                {if $transaction_data['sub_product_name'] neq ''}
                                <div class="hr-line-dashed"></div>

                                <div class="form-group">
                                    <div class="col-md-2" style="text-align:right">
                                        <input type="checkbox" class="i-checks" id="sub_product_req" name="sub_product_req" value="1" {if $transaction_data['sub_product_req'] eq '1' }checked{/if} {*if $type eq 'view'*} disabled {*/if*}>
                                    </div>
                                    <div class="col-md-2" style="text-align: left">
                                        <span style="font-size: 12pt; font-weight: 600">{$transaction_data['sub_product_name']}</span>
                                    </div>
                                    <div class="col-md-8" style="text-align: right">
                                        <span class="amount" style="font-weight: 600" autocomplete="off" data-a-sign="{$config['currency_code']} " data-a-dec="{$config['dec_point']}" data-a-sep="{$config['thousands_sep']}" data-d-group="2">{$transaction_data['sub_product_price']}</span>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2" style="text-align: right">
                                        <span class="amount total_price" style="font-weight: 600" autocomplete="off" data-a-sign="{$config['currency_code']} " data-a-dec="{$config['dec_point']}" data-a-sep="{$config['thousands_sep']}" data-d-group="2">{if $transaction_data['sub_product_req'] eq '1'}{$transaction_data['product_price']+$transaction_data['sub_product_price']}{else}{$transaction_data['product_price']}{/if}</span>
                                    </div>
                                </div>
                                {/if}
                                ...
                                <input type="hidden" id="product_name" name="product_name" value="{$transaction_data['product_name']}">
                                <input type="hidden" id="product_price" name="product_price" value="{$transaction_data['product_price']}">
                                <input type="hidden" id="sub_product_name" name="sub_product_name" value="{$transaction_data['sub_product_name']}">
                                <input type="hidden" id="sub_product_price" name="sub_product_price" value="{$transaction_data['sub_product_price']}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-10 col-md-2" style="text-align: right">
                                        {if $type eq 'view'}
                                            {*<button type="submit" id="back_submit" class="btn btn-primary">Back</button>*}
                                        {else}
