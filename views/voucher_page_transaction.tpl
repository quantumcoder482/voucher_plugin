                                    ...
                                    <div class="table-responsive" id="ib_data_panel">
                                        <table class="table table-bordered table-hover display" id="ib_dt">
                                            ...
                                            <tr class="heading">
                                                ...
                                                <td><input type="text" id="filter_title" name="filter_title" class="form-control"></td>
...
{/block}
{block name="script"}
    <script type="text/javascript" src="{$app_url}apps/voucher/views/js/voucher_page_transaction.js"></script>
{/block}
